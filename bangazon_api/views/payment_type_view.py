...
class PaymentTypeView(ViewSet):
    ...
    def list(self, request):
        ...
        payment_types = PaymentType.objects.filter(customer=request.auth.user) #CT change from .all to .filter
    ...
    def create(self, request):
        ...
        try:
            payment_type = PaymentType.objects.create(
                ...
                merchant_name=request.data['merchant'], #CT fixed bracket notation 
                acct_number=request.data['acctNumber']  #CT fixed bracket notation
            )
